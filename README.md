...
This will copy the ui-tinymce files into your `components` folder, along with its dependencies. Load the script files in your application:
    ...
    <script type="text/javascript" src="app/components/tinymce/tinymce.min.js"></script>
    <script type="text/javascript" src="app/components/angular/angular.js"></script>
    <script type="text/javascript" src="app/components/angular-ui-tinymce/src/tinymce.js"></script>
